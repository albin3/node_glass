...
exports.getStores = function(query, callback) {
  dbstore.find({lan: query.lan}).sort({province: 1, municipality: 1, area: 1, address: 1, name: 1, telephone: -1}).skip((query.skip-1)*query.limit).limit(query.limit, function(err, docs){
    if (err) 
